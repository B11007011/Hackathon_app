  ...
  return (
    ...
    <div className="flex flex-col h-full w-full bg-background">
          ...
          <div className="flex items-center ml-auto gap-2 sm:gap-4">
            ...
            <Drawer>
              ...
              <DrawerContent className="max-h-[85vh]">
                ...
                <ScrollArea className="h-[50vh] px-4 hide-scrollbar overflow-y-auto">
      ...
      <main className="flex-1 overflow-hidden relative">
        <ScrollArea className="h-full w-full hide-scrollbar overflow-y-auto" style={{ paddingBottom: "calc(env(safe-area-inset-bottom) + 48px)" }}>
